...
class billing:
        def    __init__(self,root):
            ...
            #  title
            title=Label(self.root,text="Retail Management",font=("times new roman",40,"bold"),bg="#795C32",fg="white",padx=20).place(x=0,y=0,relwidth=1,height=70)

             #  button log out
            btn_log=Button(self.root,text="LOGOUT",font=("times new roman",10,"italic"),bg="#BEBDB8",fg="#2B1700",cursor="hand2",anchor="w",bd=3,padx=30).place(x=1150,y=20,height=30,width=120)

            b_title=Label(self.root,text=" Manage Bill",font=("times new roman",25,"bold"),bg="orange",fg="black").place(x=0,y=70,relwidth=1,height=32)
            ...
            ptitle=Label(prod1_frame,text="All Products",font=("times new roman",20,"bold"),bg="#FD6A02",fg="#883000").pack(side=TOP,fill=X)

            prod2_frame=Frame(prod1_frame,bd=3,relief=RIDGE)
            prod2_frame.place(x=2,y=42,height=90,width=390)

            psearch=Label(prod2_frame,text="Search product",font=("times new roman",10,"bold"),bg="#6E4C92",fg="white").place(x=2,y=5)

            lbl_name=Label(prod2_frame,text="Product name",font=("times new roman",10,"bold")).place(x=5,y=45)

            txt_search=Entry(prod2_frame,textvariable=self.var_search,bd=3,font=("times new roman",10,"bold")).place(x=90,y=45)

            butt_search=Button(prod2_frame,text="Search",command=self.search,font=("times new roman",10,"bold"),cursor="hand2",bg="#1134A6",fg="white").place(x=250,y=45)

            butt_show=Button(prod2_frame,text="Show all",command=self.showall,font=("times new roman",10,"bold"),cursor="hand2",bg="#1134A6",fg="white").place(x=250,y=5)
...
###########=TREEVIEW============
            ...
            ctitle=Label(prod4_frame,text="Customer details",font=("times new roman",20,"bold"),bg="#351E10",fg="red").pack(side=TOP,fill=X)
    ...
    #=====calculator==========
        ...
        #=============CART FRAME========
            ...
            self.cctitle=Label(cart_frame,text="Cart   total  Products [0]",font=("times new roman",10),fg="black")
        ...
        #=MENU ADD CART BUTTON====
            ...
            btn_clr=Button(add_cart_frame,text="Clear",command=self.clear_cart,font=("times new roman",10,"bold"),cursor="hand2",fg="white",bg="black",bd=3).place(x=280,y=35)
            btn_add=Button(add_cart_frame,text="Add | Update cart",command=self.ad_update,font=("times new roman",10,"italic"),cursor="hand2",bg="black",fg="white",bd=3).place(x=280,y=65)
            ...
            btitle=Label(billframe,text="Bill Area",font=("times new roman",20,"bold"),bg="brown",fg="white").pack(side=TOP,fill=X)
            ...
            self.lbl_amt=Label(bbillframe,text="Bill amount\n [0]",font=("times new roman",10),fg="black",bg="#A45A52",bd=5)
            self.lbl_amt.place(x=2,y=5,width=120,height=60)

            self.dis=Label(bbillframe,text="Discount\n [5%]",font=("times new roman",10),fg="black",bg="#A45A52",bd=3)
            self.dis.place(x=124,y=5,width=120,height=60)

            self.netpay=Label(bbillframe,text="Net Pay\n [0]",font=("times new roman",10),fg="black",bg="#A45A52",bd=3)
            self.netpay.place(x=246,y=5,width=120,height=60)

            clear=Button(bbillframe,text="Clear all",command=self.clear_all,font=("times new roman",10),cursor="hand2",fg="black",bg="#A45A52",bd=3)
            clear.place(x=2,y=74,width=120,height=50)

            addd=Button(bbillframe,text="Generate bill",command=self.generate_bill,font=("times new roman",10),cursor="hand2",fg="black",bg="#A45A52",bd=3)
