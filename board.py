...
class IMS:
        ...
        def    __init__(self,root):
            ...
            btn_pro=Button(leftmenu,text="PRODUCTS",command=self.product,image=self.Logo,compound=LEFT,font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2",anchor="w")
