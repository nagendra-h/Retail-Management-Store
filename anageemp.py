...
##-----------   USER_ID--------
            ...
            nam_Eemp.place(x=771,y=20,height=40,width=210)

            ###---------DOJ -----------
            doj_Eemp=Entry(self.root,textvariable=self.var_doj,font=("times new roman" ,15),bg="white",bd=4)
            doj_Eemp.place(x=271,y=80,height=40,width=210)
            ...
            add_emp=Button(self.root,text="ADD",command=self.add,font=("times new roman" ,15),bg="#BDB7AB",fg="black",bd=4)
            add_emp.place(x=271,y=180,height=40,width=110)

            delete_emp=Button(self.root,text="DELETE",command=self.delete,font=("times new roman" ,15),bg="#BDB7AB",fg="black",bd=4)
            delete_emp.place(x=471,y=180,height=40,width=130)

            update_emp=Button(self.root,text="UPDATE",command=self.update,font=("times new roman" ,15),bg="#BDB7AB",fg="black",bd=4)
            update_emp.place(x=671,y=180,height=40,width=130)


            clear_emp=Button(self.root,text="CLEAR",command=self.clear,font=("times new roman" ,15),bg="#BDB7AB",fg="black",bd=4)
